...
clean=RepeatChore.create(title:"Clean your room",description:"Clean your room",point_value:20,repeat_every:["month"],cycle_between:false,participants:[(adam.id),(brian.id),(brandon.id)])
...
trash=RepeatChore.create(title:"Take out the trash",description:"Take the garbage out to the curb",point_value:10,repeat_every:["tuesday","friday"],cycle_between:true,participants:[(adam.id),(brian.id)])
...
plants=RepeatChore.create(title:"Water Plants",description:"Water all the plants in the kitchen",point_value:10,repeat_every:["week"],cycle_between:false,participants:[(brandon.id)])
