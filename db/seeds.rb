...
clean=RepeatChore.create(title:"Clean your room",description:"Clean your room",point_value:20,repeat_every:["month"],cycle_between:false,participants:[(adam.id),(brian.id),(brandon.id)],due_date:"2023-08-20T18:45 -0400")
    brians_room=Chore.create(title:"Clean your room",description:"Clean your room",point_value:20,completed:1,user_id:brian.id,repeat_chore_id:clean.id,due_date:"2023-08-20T18:45 -0400")
    adams_room=Chore.create(title:"Clean your room",description:"Clean your room",point_value:20,completed:0,user_id:adam.id,repeat_chore_id:clean.id,due_date:"2023-08-20T18:45 -0400")
    brandons_room=Chore.create(title:"Clean your room",description:"Clean your room",point_value:20,completed:1,user_id:brandon.id,repeat_chore_id:clean.id,due_date:"2023-08-20T18:45 -0400")
trash=RepeatChore.create(title:"Take out the trash",description:"Take the garbage out to the curb",point_value:10,repeat_every:[2,5],cycle_between:true,participants:[(adam.id),(brian.id)],due_date:"2023-08-20T18:45 -0400")
    trash_one=Chore.create(title:"Take out trash",description:"Take out the trash",point_value:10,completed:0,user_id:mom.id,repeat_chore_id:trash.id,due_date:"2023-08-20T18:45 -0400")
plants=RepeatChore.create(title:"Water Plants",description:"Water all the plants in the kitchen",point_value:10,repeat_every:["week"],cycle_between:false,participants:[(brandon.id)],due_date:"2023-08-20T18:45 -0400")
    plants_one=Chore.create(title:"Water Plants",description:"Water all the plants in the kitchen",point_value:10,completed:1,user_id:brandon.id,repeat_chore_id:plants.id,due_date:"2023-08-20T18:45 -0400")
brians=Chore.create(title:"Set Table",description:"Set the dining room table",point_value:15,completed:1,user_id:brian.id,repeat_chore_id:repeat_chore_token.id,due_date:"2023-08-20T18:45 -0400")
adams=Chore.create(title:"Grocery Shopping",description:"List: milk, eggs, bread, cheez its",point_value:15,completed:1,user_id:adam.id,repeat_chore_id:repeat_chore_token.id,due_date:"2023-08-24T08:00 -0400")
brandons=Chore.create(title:"Help dad change tire",description:"Go to garage at noon, dad needs help",point_value:20,completed:0,user_id:brandon.id,repeat_chore_id:repeat_chore_token.id,due_date:"2023-08-20T10:30 -0400")
        extra_chore=Chore.create(title:"Clean Garage",description:"Reorganize and vacuum the garage",point_value:75,completed:0,user_id:mom.id,repeat_chore_id:repeat_chore_token.id,due_date:"2023-08-31T20:00 -0400")
