...
clean=RepeatChore.create(title:"Clean your room",description:"Clean your room",point_value:20,repeat_every:["month"],cycle_between:false,participants:[(adam.id),(brian.id),(brandon.id)],time_due:"23:59:59.0000000 -0400")
...
trash=RepeatChore.create(title:"Take out the trash",description:"Take the garbage out to the curb",point_value:10,repeat_every:[2,5],cycle_between:true,participants:[(adam.id),(brian.id)],time_due:"20:00:00.0000000 -0400")
...
plants=RepeatChore.create(title:"Water Plants",description:"Water all the plants in the kitchen",point_value:10,repeat_every:["week"],cycle_between:false,participants:[(brandon.id)],time_due:"23:59:59.0000000 -0400")
