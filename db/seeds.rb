...
trash=RepeatChore.create(title:"Take out the trash",description:"Take the garbage out to the curb",point_value:10,repeat_every:[2,5],cycle_between:true,participants:[(adam.id),(brian.id)])
